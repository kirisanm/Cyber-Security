...
try:
    ...
    if start == '1':
       ...
       #print("encryption 1, with key: ", key,". Encrypted: ", translated)
       
       translated2 = encrypt(key2, translated)
       print("final encryption result with key:", key, "and", key2, "is:", translated2)
